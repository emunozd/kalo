...
class RegistroCaloria(Base):
    ...
    registrado_en:Mapped[datetime]      = mapped_column(DateTime(timezone=True), server_default=func.now())  # momento exacto
...
class RegistroEjercicio(Base):
    ...
    registrado_en:  Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())  # momento del registro
    descripcion:    Mapped[str]      = mapped_column(Text, nullable=False)
...
class ResumenDiario(Base):
    ...
    primera_entrada_en: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
    actualizado_en:     Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
